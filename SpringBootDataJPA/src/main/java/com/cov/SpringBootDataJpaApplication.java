...
public class SpringBootDataJpaApplication {
	...
	public static void main(String[] args) {
		...
		Department department2 = new Department(2, "Boss");
		Employee employee1 = new Employee(101, "Animesh", department1);
		Employee employee2 = new Employee(102, "Anirudha", department1);
		Employee employee3 = new Employee(103, "Rubesh", department2);
		Employee employee4 = new Employee(104, "Kapil", department2);
